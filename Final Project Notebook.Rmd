...
med_train_pivot = med_train %>% pivot_wider(names_from = generic_name, values_from = days_med_adm, values_fn = mean)
...
proc_train_pivot = proc_train %>% pivot_wider(names_from = procedure_id, values_from = days_pro_adm, values_fn = mean)
...
#remove patient id, admission/discharge dates, and length of stay to get final training set
train_final = subset(merged_train_df,select= -c(patient_num,admission_date,discharge_date,los))
```
