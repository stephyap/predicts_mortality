...
auc = double(10)
labels = validation$death
pred = predict(lasso.model, newx=x.test, type="response", s=0.01)
for (i in 1:10){
...
```{r}
plot(thresholds,auc[1:10],type="b",ylab="AUC",main="AUC VS Threshold",col="blue")
points(thresholds[best],auc[best],pch=19,col="red")
abline(v=c(0.0,0.2,0.4,0.6,0.8,1),lty=2,col="darkgrey")
abline(h=c(0.5,0.6,0.7,0.8,0.9),lty=2,col="darkgrey")
```
