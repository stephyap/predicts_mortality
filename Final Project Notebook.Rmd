...
# use binary meds and procs, the accuracy is 85.7%
```{r}
#fit model on training data
glm.fit=glm(death~., data=train[, -1], family=binomial)
...
# use the binary meds or proc variable, we get 0.83511
```{r}
#fit model
boost = gbm(death~.,data=train[,-1],distribution='bernoulli',n.trees=1000,shrinkage=0.01)
